...
public class TreatmentsActivity extends AppCompatActivity {
    ...
    public void onResume()
    {
        ...
        {
            FloatingActionButton addTreatmentsIcon = (FloatingActionButton) findViewById(R.id.newTreatmentIcon);
            addTreatmentsIcon.setVisibility(View.VISIBLE);
        /*Drawable myFabSrc = getResources().getDrawable(android.R.drawable.ic_input_add);
        Drawable willBeWhite = myFabSrc.getConstantState().newDrawable();
        willBeWhite.mutate().setColorFilter(Color.WHITE, PorterDuff.Mode.MULTIPLY);
        addTreatmentsIcon.setImageDrawable(willBeWhite);*/
            addTreatmentsIcon.setOnClickListener(new View.OnClickListener() {
                @Override
        ...
        treatmentsAdapterFirebase.getTreatmentsList(new TreatmentsAdapterFirebase.GetTreatmentListListener() {
            ...
            public void onComplete(final List<Treatments> treatmentsList)
            {
                ...
                treatmentsAdapter = new TreatmentsAdapter(getApplicationContext(), treatmentsList, new TreatmentsAdapter.TreatmentsAdapterListener() {
                    @Override
                    public void onClientSelected(Treatments treatment) {
                        Intent intent = new Intent(TreatmentsActivity.this, TreatmentViewActivity.class);
                         intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                         Bundle b = new Bundle();
                            b.putString("id",treatment.getId());
                            intent.putExtras(b);
                          startActivity(intent);
